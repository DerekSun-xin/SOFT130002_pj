...
<head>
    <meta charset="UTF-8">
    <title>Basic Bootstrap File</title>
    <meta charset="utf-8">
...
<!--<form>
    <div>
        <input type="radio" id="Heat" value="Sort According to Heat">
        <label for="Heat">Sort According to Heat</label>
    </div>
   <div>
...
$returnArrayArtworkIDup=$_GET["returnArrayArtworkID"];
...
?>
    ...
    <table style='width: 100%'>
        ...
        $sql4 ="SELECT * FROM artworks WHERE artworkID IN (".implode(',',$returnArrayArtworkID).") LIMIT $mark , $pageSize " ;
...
<script>        window.location=encodeURI("SearchResult.php?returnArrayArtworkID="+returnArrayArtworkID+"&returnArrayTitle="+returnArrayTitle+"&returnArrayArtist="+returnArrayArtist+"&returnArrayView="+returnArrayView);
</script>
    <!--<ul class="pagination">
    ...
    <div style="text-align: center">
        ...
        <a href="Test.php?page=<?php echo $firstPage;?>&returnArrayArtworkID=<?php echo $returnArrayArtworkIDup?>">FirstPage</a>
        &nbsp;&nbsp;
        <a href="Test.php?page=<?php echo $prePage;?>&returnArrayArtworkID=<?php echo $returnArrayArtworkIDup?>">PrePage</a>
        &nbsp;&nbsp;
        <a href="Test.php?page=<?php echo $nextPage;?>&returnArrayArtworkID=<?php echo $returnArrayArtworkIDup?>">NextPage</a>
        &nbsp;&nbsp;
        <a href="Test.php?page=<?php echo $lastPage;?>&returnArrayArtworkID=<?php echo $returnArrayArtworkIDup?>">LastPage</a>
        &nbsp;&nbsp;
    </div>
